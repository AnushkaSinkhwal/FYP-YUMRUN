 ...
 * @access  Private
 */
router.get('/loyalty', protect, emailVerificationCheck, userController.getLoyaltyDetails);

/**
 * @route   GET /api/user/loyalty/points
 * @desc    Get the user's loyalty points
 * @access  Private
 */
router.get('/loyalty/points', protect, emailVerificationCheck, async (req, res) => {
  try {
    ...
    return res.status(200).json({
      ...
      data: {
        ...
        lifetimePoints: user.lifetimeLoyaltyPoints || 0,
 ...
 * @desc    Get the user's loyalty points history
 * @access  Private
 */
router.get('/loyalty/history', protect, emailVerificationCheck, async (req, res) => {
  try {
    const userId = req.user._id;
 ...
 * @access  Private
 */
router.post('/loyalty/redeem', protect, emailVerificationCheck, async (req, res) => {
  try {
