                    ...
                    <div className="row d-flex align-items-center w-100">
                        ...
                        <div className="col-sm-2 part1">
                            <Link to={'/'} className="d-flex align-items-center logo">
                                <img src={logo} />
                                <span className="ml-2">YUMRUN</span>
                            </Link>
                        </div>
                                    ...
                                    <div className='scroll'>
                                        <MenuItem onClick={handleCloseMyAccDrop}>
                                            <div className='d-flex'>
                                                <div>
                                                    <UserAvatarImgComponent img={'https://png.pngtree.com/png-clipart/20190516/original/pngtree-cute-girl-avatar-material-png-image_4023832.jpg'}/>
                                                </div>
                                ...
                                context.isLogin !== true ?
                                    ...
                                    <div className="myAccWrapper">
                                        ...
                                        >
                                            <div className="userImg">
                                                <span className="rounded-circle">
                                                    <img src="https://cdn4.iconfinder.com/data/icons/circle-avatars-1/128/050_girl_avatar_profile_woman_suit_student_officer-2-1024.png" />
                                                </span>
                                            </div>

                                            <div className="userInfo res-hide">
                                                <h4>Anushka Sinkhwal</h4>
                                                <p className="mb-0">@anushka77</p>
                                            </div>
